...
import com.makrozai.eligiushiddenarmor.StartupLogger;
...
public class UpdateChecker {
    ...
    private static final String API_URL = "https://api.github.com/repos/Eligiusmc/EligiusHiddenArmor/releases/latest";
    private static final String FALLBACK_DOWNLOAD_URL = "https://github.com/Eligiusmc/EligiusHiddenArmor/releases/latest";
    ...
    public static void fetch(String currentVersion) {
        ...
        HttpRequest request = HttpRequest.newBuilder()
                ...
                .header("User-Agent", "EligiusHiddenArmor-UpdateChecker")
                .GET()
                .build();
