...
public class StartupLogger {
    ...
    public static void printLogo(String version, String platform, String storage) {
        String[] lines = {
            ...
            "<gradient:#9b59b6:#8e44ad>     ( o.o )      </gradient><aqua>Hidden Armor Plugin v" + version + "</aqua>",
    ...
    public static void printStep(String step) {
        log("<gray>[<gradient:#9b59b6:#8e44ad>EligiusHiddenArmor</gradient>]</gray> <white>" + step + "</white>");
    }

    public static void printError(String error) {
        log("<gray>[<gradient:#9b59b6:#8e44ad>EligiusHiddenArmor</gradient>]</gray> <red>[ERROR] " + error + "</red>");
    }

    public static void printSuccess(long ms) {
        log("<gray>[<gradient:#9b59b6:#8e44ad>EligiusHiddenArmor</gradient>]</gray> <green>Successfully enabled. (took " + ms + "ms)</green>");
    }

    public static void printUpToDate(String version) {
        log("<gray>[<gradient:#9b59b6:#8e44ad>EligiusHiddenArmor</gradient>]</gray> <green>✓ You are running the latest version (v" + version + ").</green>");
    }

    public static void printUpdateNotice(String newVersion, String url) {
        log("<gray>[<gradient:#9b59b6:#8e44ad>EligiusHiddenArmor</gradient>]</gray> <yellow>⚠️ A new update (v" + newVersion + ") is available!</yellow>");
        log("<gray>[<gradient:#9b59b6:#8e44ad>EligiusHiddenArmor</gradient>]</gray> <dark_gray>🔗 Download it here:</dark_gray> <aqua><underlined>" + url + "</underlined></aqua>");
    }
}
